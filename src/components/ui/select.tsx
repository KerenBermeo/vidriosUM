...
// Re-exportamos los componentes base de Radix con nombres más simples
const Select = SelectPrimitive.Root
const SelectGroup = SelectPrimitive.Group
const SelectValue = SelectPrimitive.Value

/**
 * Componente Trigger personalizado para el Select.
 * Maneja la apertura/cierre del menú y muestra el valor seleccionado.
 */
...
/**
 * Contenedor del menú desplegable con animaciones y posicionamiento
 */
...
/**
 * Etiqueta para agrupar items en el menú
 */
...
/**
 * Item individual dentro del menú desplegable
 */
